...
public abstract class AbstractButton extends JComponent implements ItemSelectable, SwingConstants {
	...
	/**
	 * Identifies a change to the icon used when the cursor is over the button and
	...
	/**
	 * Identifies a change to the icon used when the button has been disabled and
	 * selected.
	 */
	 ...
	 * event's only state is the source property. The source of events generated is
	 * always "this".
	 */
	...
	/**
	 * Sets the <code>hideActionText</code> property, which determines whether the
	 * button displays text from the <code>Action</code>. This is useful only if an
	 * <code>Action</code> has been installed on the button.
	 *
	 * @param hideActionText
	 *            <code>true</code> if the button's <code>text</code> property
	 *            should not reflect that of the <code>Action</code>; the default is
	 *            <code>false</code>
	 ...
	 * button.
	 *
	 * @return <code>true</code> if the button's <code>text</code> property should
	 *         not reflect that of the <code>Action</code>; the default is
	 *         <code>false</code>
	 * @since 1.6
	 */
	...
	/**
	 * Returns the state of the button. True if the toggle button is selected, false
	 * if it's not.
	 * 
	 ...
	 * <code>actionEvent</code>. Call <code>doClick</code> to perform a programmatic
	 * action change.
	 *
	 * @param b
	 ...
	 * had pressed and released the button.
	 */
	public void doClick() {
		doClick(68);
	}
	 ...
	 * <code>null</code> will cause the button to use the default margin. The
	 * button's default <code>Border</code> object will use this value to create the
	 * proper margin. However, if a non-default border is set on the button, it is
	 * that <code>Border</code> object's responsibility to create the appropriate
	 * margin space (else this property will effectively be ignored).
	 *
	 * @param m
	 ...
	 * @see #getIcon
	 * @see #setPressedIcon
	 * @beaninfo bound: true attribute: visualUpdate true description: The button's
	 *           default icon
	 */
	public void setIcon(Icon defaultIcon) {
		...
		/*
		 * If the default icon has really changed and we had generated the disabled icon
		 * for this component, (i.e. setDisabledIcon() was never called) then clear the
		 * disabledIcon field.
		 */
		...
		if (defaultIcon != oldValue) {
			if (defaultIcon == null || oldValue == null || defaultIcon.getIconWidth() != oldValue.getIconWidth()
	 ...
	 * @see #getPressedIcon
	 * @beaninfo bound: true attribute: visualUpdate true description: The pressed
	 *           icon for the button.
	 */
	 ...
	 * @see #getSelectedIcon
	 * @beaninfo bound: true attribute: visualUpdate true description: The selected
	 *           icon for the button.
	 */
	public void setSelectedIcon(Icon selectedIcon) {
		...
		/*
		 * If the default selected icon has really changed and we had generated the
		 * disabled selected icon for this component, (i.e. setDisabledSelectedIcon()
		 * was never called) then clear the disabledSelectedIcon field.
		 */
	 ...
	 * @see #getRolloverIcon
	 * @beaninfo bound: true attribute: visualUpdate true description: The rollover
	 *           icon for the button.
	 */
	...
	/**
	 * Returns the icon used by the button when it's disabled. If no disabled icon
	 * has been set this will forward the call to the look and feel to construct an
	 * appropriate disabled Icon.
	 * <p>
	 * Some look and feels might not render the disabled Icon, in which case they
	 * will ignore this.
	 *
	 ...
	 * @see #getDisabledIcon
	 * @beaninfo bound: true attribute: visualUpdate true description: The disabled
	 *           icon for the button.
	 */
	...
	/**
	 * Returns the icon used by the button when it's disabled and selected. If no
	 * disabled selection icon has been set, this will forward the call to the
	 * LookAndFeel to construct an appropriate disabled Icon from the selection icon
	 * if it has been set and to <code>getDisabledIcon()</code> otherwise.
	 * <p>
	 ...
	 *           visualUpdate true description: The vertical alignment of the icon
	 *           and text.
	 */
	 ...
	 *
	 * @return the <code>horizontalAlignment</code> property, one of the following
	 *         values:
	 *         <ul>
	...
	/**
	 * Sets the horizontal alignment of the icon and text. {@code AbstractButton}'s
	 * default is {@code SwingConstants.CENTER}, but subclasses such as
	 * {@code JCheckBox} may use a different default.
	 *
	 * @param alignment
	 ...
	 *           SwingConstants.LEADING TRAILING SwingConstants.TRAILING attribute:
	 *           visualUpdate true description: The horizontal alignment of the icon
	 *           and text.
	 */
	 ...
	 * 
	 * @return the <code>verticalTextPosition</code> property, one of the following
	 *         values:
	 *         <ul>
	 *         <li>{@code SwingConstants.CENTER} (the default)
	 *         <li>{@code SwingConstants.TOP}
	 ...
	 * @beaninfo bound: true enum: TOP SwingConstants.TOP CENTER
	 *           SwingConstants.CENTER BOTTOM SwingConstants.BOTTOM attribute:
	 *           visualUpdate true description: The vertical position of the text
	 ...
	 *                if <code>textPosition</code> is not one of the legal values
	 *                listed above
	 * @beaninfo bound: true enum: LEFT SwingConstants.LEFT CENTER
	 *           SwingConstants.CENTER RIGHT SwingConstants.RIGHT LEADING
	 *           SwingConstants.LEADING TRAILING SwingConstants.TRAILING attribute:
	 *           visualUpdate true description: The horizontal position of the text
	 *           relative to the icon.
	 */
	 ...
	 * @since 1.4
	 * @see #getIconTextGap
	 * @beaninfo bound: true attribute: visualUpdate true description: If both the
	 *           icon and text properties are set, this property defines the space
	 *           between them.
	 */
	 ...
	 * {@code horizontalAlignment} and {@code horizontalTextPosition} properties.
	 * Valid values are:
	 * <ul>
	 * <li>{@code SwingConstants.RIGHT}
	 * <li>{@code SwingConstants.LEFT}
	 ...
	 * @param exception
	 *            the message to use in the {@code IllegalArgumentException} that is
	 ...
	 * Supporting <code>Action</code></a>. Subsequently, the button's properties are
	 * automatically updated as the <code>Action</code>'s properties change.
	 * <p>
	 ...
	 * button's properties. To track changes in the <code>Action</code>'s property
	 ...
	 *
	 * @param a
	 *            the <code>Action</code> for the <code>AbstractButton</code>, or
	 *            <code>null</code>
	 * @since 1.3
	 * @see Action
	 * @see #getAction
	...
	/**
	 * Button subclasses that support mirroring the selected state from the action
	 * should override this to return true. AbstractButton's implementation returns
	 * false.
	 */
	...
	/**
	 * Sets the seleted state of the button from the action. This is defined here,
	 * but not wired up. Subclasses like JToggleButton and JCheckBoxMenuItem make
	 * use of it.
	 *
	 * @param a
	 *            the Action
	 ...
	 * If you do the lifetime of the button will be tied to that of the
	 * <code>Action</code>.
	 *
	 * @param a
	 *            the button's action
	...
	/**
	 * Sets the <code>borderPainted</code> property. If <code>true</code> and the
	 * button has a border, the border is painted. The default value for the
	 ...
	 *
	 * @param b
	 *            if true and border property is not <code>null</code>, the border
	 *            is painted
	 * @see #isBorderPainted
	 * @beaninfo bound: true attribute: visualUpdate true description: Whether the
	...
	/**
	 * Paint the button's border if <code>BorderPainted</code> property is true and
	...
	/**
	 * Sets the <code>paintFocus</code> property, which must be <code>true</code>
	 * for the focus state to be painted. The default value for the
	 * <code>paintFocus</code> property is <code>true</code>. Some look and feels
	 * might not paint focus state; they will ignore this property.
	 *
	 * @param b
	 *            if <code>true</code>, the focus state should be painted
	 * @see #isFocusPainted
	 * @beaninfo bound: true attribute: visualUpdate true description: Whether focus
	 *           should be painted
	 */
	...
	/**
	 * Sets the <code>contentAreaFilled</code> property. If <code>true</code> the
	 * button will paint the content area. If you wish to have a transparent button,
	 * such as an icon only button, for example, then you should set this to
	 * <code>false</code>. Do not call <code>setOpaque(false)</code>. The default
	 * value for the the <code>contentAreaFilled</code> property is
	 * <code>true</code>.
	 * <p>
	 ...
	 *
	 * @param b
	 *            if true, the content should be filled; if false the content area
	 *            is not filled
	 * @see #isContentAreaFilled
	 * @see #setOpaque
	 * @beaninfo bound: true attribute: visualUpdate true description: Whether the
	 *           button should paint the content area or leave it transparent.
	 */
	 ...
	 * <code>rolloverEnabled</code> property is <code>false</code>. Some look and
	 * feels might not implement rollover effects; they will ignore this property.
	 *
	 * @param b
	 ...
	 * which when combined with the look and feel's mouseless modifier (usually Alt)
	 * will activate this button if focus is contained somewhere within this
	 ...
	 * <code>java.awt.event.KeyEvent.getExtendedKeyCodeForChar</code>. Mnemonics are
	 * case-insensitive, therefore a key event with the corresponding keycode would
	 * cause the button to be activated whether or not the Shift modifier was
	 * pressed.
	 * <p>
	 * If the character defined by the mnemonic is found within the button's label
	 ...
	 *
	 * @beaninfo bound: true attribute: visualUpdate true description: the keyboard
	 *           character mnemonic
	 */
	...
	/**
	 * This method is now obsolete, please use <code>setMnemonic(int)</code> to set
	 * the mnemonic for a button. This method is only designed to handle character
	 ...
	 * the 'A' to be decorated, as 'Save <u>A</u>s', you would have to invoke
	 ...
	 * @exception IllegalArgumentException
	 *                will be thrown if <code>index</code> is &gt;= length of the
	 *                text, or &lt; -1
	...
	/**
	 * Update the displayedMnemonicIndex property. This method is called when either
	 * text or mnemonic changes. The new value of the displayedMnemonicIndex
	 * property is the index of the first occurrence of mnemonic in text.
	 */
	 ...
	 * called when model's mnemonic changes. Also updates the displayedMnemonicIndex
	 * property.
	 */
	...
	/**
	 * Sets the amount of time (in milliseconds) required between mouse press events
	 * for the button to generate the corresponding action events. After the initial
	 * mouse press occurs (and action event generated) any subsequent mouse press
	 * events which occur on intervals less than the threshhold will be ignored and
	 * no corresponding action event generated. By default the threshhold is 0,
	 * which means that for each mouse press, an action event will be fired, no
	 * matter how quickly the mouse clicks occur. In buttons where this behavior is
	 * not desirable (for example, the "OK" button in a dialog), this threshhold
	 * should be set to an appropriate positive value.
	 *
	 * @see #getMultiClickThreshhold
	 * @param threshhold
	 *            the amount of time required between mouse press events to generate
	...
	/**
	 * Gets the amount of time (in milliseconds) required between mouse press events
	 * for the button to generate the corresponding action events.
	 *
	 * @see #setMultiClickThreshhold
	 * @return the amount of time required between mouse press events to generate
	 *         corresponding action events
	 * @since 1.4
	 */
	...
	/**
	 * Resets the UI property to a value from the current look and feel. Subtypes of
	 * <code>AbstractButton</code> should override this to update the UI. For
	...
	/**
	 * Adds the specified component to this container at the specified index, refer
	 * to {@link java.awt.Container#addImpl(Component, Object, int)} for a complete
	...
	/**
	 * Removes an <code>ActionListener</code> from the button. If the listener is
	 * the currently set <code>Action</code> for the button, then the
	...
	protected void fireActionPerformed(ActionEvent event) {
		// Guaranteed to return a non-null array
		Object[] listeners = listenerList.getListenerList();//这里就是应用层实现的ActionListener
		ActionEvent e = null;
		// Process the listeners last to first, notifying
		// those that are interested in this event
		for (int i = listeners.length - 2; i >= 0; i -= 2) {
	...
	protected void fireItemStateChanged(ItemEvent event) {
		...
		if (accessibleContext != null) {
			if (event.getStateChange() == ItemEvent.SELECTED) {
				...
				accessibleContext.firePropertyChange(AccessibleContext.ACCESSIBLE_VALUE_PROPERTY, Integer.valueOf(0),
						Integer.valueOf(1));
			} else {
				accessibleContext.firePropertyChange(AccessibleContext.ACCESSIBLE_STATE_PROPERTY,
						AccessibleState.SELECTED, null);
				accessibleContext.firePropertyChange(AccessibleContext.ACCESSIBLE_VALUE_PROPERTY, Integer.valueOf(1),
						Integer.valueOf(0));
			}
		}
	}
	...
	/**
	 * Returns an array (length 1) containing the label or <code>null</code> if the
	 * button is not selected.
	 *
	 * @return an array containing 1 Object: the text of the button, if the item is
	 *         selected; otherwise <code>null</code>
	 */
	 ...
	 * <P>
	 * Overriding <code>paramString</code> to provide information about the specific
	...
	protected String paramString() {
		...
		return super.paramString() + ",defaultIcon=" + defaultIconString + ",disabledIcon=" + disabledIconString
				+ ",disabledSelectedIcon=" + disabledSelectedIconString + ",margin=" + margin + ",paintBorder="
				+ paintBorderString + ",paintFocus=" + paintFocusString + ",pressedIcon=" + pressedIconString
				+ ",rolloverEnabled=" + rolloverEnabledString + ",rolloverIcon=" + rolloverIconString
				+ ",rolloverSelectedIcon=" + rolloverSelectedIconString + ",selectedIcon=" + selectedIconString
				+ ",text=" + text;
	}
	 ...
	 * <code>AbstractButton</code> class. It provides an implementation of the Java
	 * Accessibility API appropriate to button and menu item user-interface
	 * elements.
	 * <p>
	 * <strong>Warning:</strong> Serialized objects of this class will not be
	 * compatible with future Swing releases. The current serialization support is
	...
	protected abstract class AccessibleAbstractButton extends AccessibleJComponent
		 ...
		 *
		 * @return an instance of AccessibleState containing the current state of the
		 *         object
		 * @see AccessibleState
		 */
		...
		/**
		 * Get the AccessibleAction associated with this object. In the implementation
		 ...
		 * responsible for implementing the AccessibleValue interface on behalf of
		 * itself.
		 *
		 * @return this object
		 */
		...
		/**
		 * Returns the number of Actions available in this object. The default behavior
		 * of a button is to have one action - toggle the button.
		 *
		 ...
		 *
		 * @return An Integer of 0 if this isn't selected or an Integer of 1 if this is
		 *         selected.
		 ...
		 * parent container whose ancestor container is a valid top-level window) for
		 * this method to be able to return a meaningful value.
		 *
		 * @param p
		...
		/**
		 * Determine the bounding box of the character at the given index into the
		 ...
		 * @return the screen coordinates of the character's the bounding box, if index
		 *         is invalid returns an empty rectangle.
		 * @since 1.3
		 */
		...
		private Rectangle getTextRectangle() {
			...
			String clippedText = SwingUtilities.layoutCompoundLabel(AbstractButton.this, getFontMetrics(getFont()),
					text, icon, AbstractButton.this.getVerticalAlignment(),
					AbstractButton.this.getHorizontalAlignment(), AbstractButton.this.getVerticalTextPosition(),
		...
		class ButtonKeyBinding implements AccessibleKeyBinding {
			 ...
			 * underlying implementation of the key. For example, if the Object returned is
			 * a javax.swing.KeyStroke, the user of this method should do the following:
			 * <nf><code>
